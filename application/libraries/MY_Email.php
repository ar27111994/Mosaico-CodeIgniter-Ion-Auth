...
class MY_Email extends CI_Email
{
    ...
    // Main controller
    private $main_controller = 'Email_templates';
    private $main_method = 'send_pending_emails';
    ...
    public function start_process()
    {
        ...
        $exec = shell_exec("{$this->phpcli} {$filename} {$this->main_controller} {$this->main_method}");
        return $exec;
    }
    /**
     * Send queue
    ...
    public function send_queue()
    {
        ...
        $config = $this->CI->config->item("email_config", "email");
